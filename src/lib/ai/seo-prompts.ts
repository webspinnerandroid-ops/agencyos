...
export function getBlogPrompt(brandVoice?: string, seoContext?: SeoContext): string {
  ...
  const wordCount = seoContext?.targetWordCount ?? 1500;
...
8. **Word Count**: The final body text (excluding title, meta, and headings structure) should be approximately ${wordCount} words.
